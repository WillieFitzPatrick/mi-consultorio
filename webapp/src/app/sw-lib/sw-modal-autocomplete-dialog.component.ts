...
/*
                 [class.selectedClass]="i == selectedLiValue"     


      <div mat-dialog-actions>
        <button mat-button [mat-dialog-close]="{}">Cancelar</button>
        
        <button mat-button [mat-dialog-close]="optionSelected" 
                           cdkFocusInitial>
            Aceptar
        </button>
      </div>
...
*/
@Component({
  selector: 'app-sw-autocomplete-dialog',
  template: `
      <h2>{{data.title}}</h2>
...
export class SwModalAutocompleteDialogComponent implements OnInit {
   ...
   constructor( public dialogRef: MatDialogRef<SwModalAutocompleteDialogComponent>,
